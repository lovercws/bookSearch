...
<body>
	<table id="downloadHistory" class="easyui-datagrid" data-options="iconCls:'icon-help',plain:true,fitColumns:true,rownumbers:true,singleSelect:true,pagePosition:'bottom',pageNumber:1,pageSize:10,title:'上传记录'" style="width: 100%;height: 96%;position: relative;">
		<thead>
			<tr>
